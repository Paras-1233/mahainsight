...
export default function CriticalAlerts() {
  ...
  return (
    <div className="relative w-full overflow-hidden rounded-2xl border border-red-500/20 bg-red-500/10 px-5 py-3">
      ...
      <div className="relative flex flex-col gap-3 lg:flex-row lg:items-center">
        ...
        <div className="flex flex-wrap gap-3">
          {urgentAlerts.map((alert) => (
            <div
              key={alert.id}
              className={`rounded-xl border px-3 py-2 text-sm ${severityStyles[alert.severity]}`}
            >
